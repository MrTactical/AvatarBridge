...
all). The report names every chain in that position along with the slider responsible; if it's a
slider people will actually use, set it where you want collision to be correct before converting.
